...
export function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden px-4 py-10 sm:px-6">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(220,231,200,0.6),transparent_30%),radial-gradient(circle_at_bottom_right,rgba(237,224,214,0.7),transparent_28%)]" />
        ...
        <div className="grid w-full items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <section className="space-y-6">
            ...
            <div className="space-y-5">
              ...
              <h1 className="max-w-2xl text-5xl font-semibold leading-tight tracking-[-0.06em] text-foreground sm:text-6xl">
                사기 전에,
                <br />
                지금 있는 재고부터 확인하세요.
              </h1>
          ...
          <Card className="glass-panel overflow-hidden rounded-[2rem] bg-surface-container-lowest/90 p-0">
            <CardContent className="space-y-8 p-8 sm:p-10">
              <div className="space-y-4 text-center sm:text-left">
                ...
                <div className="space-y-2">
                  ...
                  <h2 className="text-3xl font-semibold tracking-[-0.05em]">보관함 열기</h2>
