...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-[1rem] py-2.5 pl-8 pr-2 text-sm outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[highlighted]:bg-surface-container-low data-[highlighted]:text-foreground",
        className
      )}
      {...props}
    >
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        "bg-[color:color-mix(in_srgb,var(--outline-variant)_24%,transparent)] pointer-events-none -mx-1 my-1 h-px",
        className
      )}
      {...props}
    />
